...
sudo -H -u datamade $VENV_DIR/bin/pip install -r /home/datamade/la-metro-councilmatic/requirements.txt --upgrade
sudo -H -u datamade $VENV_DIR/bin/pip install -r /home/datamade/scrapers-us-municipal/requirements.txt --upgrade
