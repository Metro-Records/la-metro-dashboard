...
mv -f $APP_PATH/configs/$APP_NAME.conf.nginx /etc/nginx/conf.d/$APP_NAME.conf
mv -f $APP_PATH/configs/$APP_NAME.conf.supervisor /etc/supervisor/conf.d/$APP_NAME.conf
